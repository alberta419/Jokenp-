# Jokenpo
Esse projeto é a execução de um trabalho acadêmico da disciplina de Racíocinio Algoritmo no curso de Sistemas da Informação.
O jogo é completamente elaborado em Python. Que foi feito a partir de alguns criterios:  
...
Feito por: Pedro Hara e Yasmim Egidio. 
